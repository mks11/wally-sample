    ...
    return (
      <div className="carbon-bar-wrapper">
        <div className={`carbon-bar-info package-info ${showInfo ? 'open' : ''}`}>
          {value ? (12 - (value % 12)) : 12} jars from fully minimizing your carbon footprint <i onClick={this.toggleCarbonBarInfo} className="fa fa-info-circle" />
          <ClickOutside onClickOutside={this.hideCarbonBarInfo}>
            <div className="package-info-popover">
              <p>Our totes are designed to hold 12 jars. By fully utilizing a tote, you are minimizing the carbon effects of your order</p>
            </div>
          </ClickOutside>
        </div>
