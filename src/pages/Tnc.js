  ...
  return (
    ...
    >
      ...
      <Typography variant="body1" gutterBottom>
        ...
        carefully before using the www.thewallyshop.co website and the Wally
        Shop mobile application (together, or individually, the "Service")
        operated by Asta Works Inc. ("us", "we", or "our").
      </Typography>
      ...
      <Typography variant="body1" gutterBottom>
        Asta Works Inc. has the right but not the obligation to monitor and edit
      ...
      <Typography variant="body1" gutterBottom>
        ...
        property of Asta Works Inc. and its licensors. The Service is protected
      ...
      <Typography variant="body1" gutterBottom>
        ...
        are not owned or controlled by Asta Works Inc.
      </Typography>
      ...
      <Typography variant="body1" gutterBottom>
        You acknowledge and agree that Asta Works Inc. shall not be responsible
      ...
      <Typography variant="body1" gutterBottom>
        You agree to defend, indemnify and hold harmless Asta Works Inc. and its
