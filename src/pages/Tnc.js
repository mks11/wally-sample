    ...
    >
      ...
      <PageSection>
        <Typography gutterBottom>
          ...
          Conditions") carefully before using the www.thewallyshop.co website
          and the Wally Shop mobile application (together, or individually, the
          "Service") operated by Asta Works Inc. ("us", "we", or "our").
        </Typography>
      ...
      <PageSection>
        ...
        <Typography gutterBottom>
          Asta Works Inc. has the right but not the obligation to monitor and
          edit all Content provided by users.
        </Typography>

        <Typography gutterBottom>
          In addition, Content found on or through this Service are the property
          of Asta Works Inc. or used with permission. You may not distribute,
      ...
      <PageSection>
        ...
        <Typography gutterBottom>
          ...
          property of Asta Works Inc. and its licensors. The Service is
          ...
          written consent of Asta Works Inc..
        </Typography>
      </PageSection>
      ...
      <PageSection>
        ...
        <Typography gutterBottom>
          ...
          that are not owned or controlled by Asta Works Inc.
        </Typography>

        <Typography gutterBottom>
          Asta Works Inc. has no control over, and assumes no responsibility for
        ...
        <Typography gutterBottom>
          You acknowledge and agree that Asta Works Inc. shall not be
      ...
      <PageSection>
        ...
        <Typography gutterBottom>
          You agree to defend, indemnify and hold harmless Asta Works Inc. and
      ...
      <PageSection>
        ...
        <Typography gutterBottom>
          In no event shall Asta Works Inc., nor its directors, employees,
      ...
      <PageSection>
        ...
        <Typography gutterBottom>
          Asta Works Inc. its subsidiaries, affiliates, and its licensors do not
