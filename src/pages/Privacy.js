...
function Privacy() {
  return (
    ...
    >
      ...
      <Typography variant="body1" gutterBottom>
        Asta Works Inc. ("us", "we", or "our") operates the www.thewallyshop.co
        website and the Wally Shop mobile application (the "Service").
      </Typography>
      ...
      <Typography variant="body1" gutterBottom>
        Asta Works Inc. will take all steps reasonably necessary to ensure that
      ...
      <Typography variant="body1" gutterBottom>
        Under certain circumstances, Asta Works Inc. may be required to disclose
      ...
      <Typography variant="body1" gutterBottom>
        Asta Works Inc. may disclose your Personal Data in the good faith belief
      ...
      <List>
        <ListItem>
          <Typography>By email: support@thewallyshop.co</Typography>
        </ListItem>
      </List>
    </Page>
  );
