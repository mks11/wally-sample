...
class ManageRetail extends Component {
  ...
  onUploadProducts = (event) => {
    ...
    if (this.isFormValid(this.state)) {
      ...
      this.adminStore.uploadProducts(fileName, formData)
        .catch(() => {
  ...
  onUploadSKUs = (event) => {
    ...
    if (this.isFormValid(this.state)) {
      ...
      formData.append('file', this.state.file[0])
      let fileName = this.state.file[0].name
      this.adminStore.uploadSKUs(fileName, formData)
        .catch(() => {
          this.modalStore.toggleModal('error')
        })
        .finally(() => {
  ...
  onUploadVendors = (event) => {
    ...
    if (this.isFormValid(this.state)) {
      ...
      formData.append('file', this.state.file[0])
      let fileName = this.state.file[0].name
      this.adminStore.uploadVendors(fileName, formData)
        .catch(() => {
          this.modalStore.toggleModal('error')
        })
        .finally(() => {
  ...
  onUploadCategories = (event) => {
    ...
    if (this.isFormValid(this.state)) {
      ...
      formData.append('file', this.state.file[0])
      let fileName = this.state.file[0].name
      this.adminStore.uploadCategories(fileName, formData)
        .catch(() => {
          this.modalStore.toggleModal('error')
        })
        .finally(() => {
  ...
  onUploadShipments = (event) => {
    ...
    if (this.isFormValid(this.state)) {
      ...
      formData.append('file', this.state.file[0])
      let fileName = this.state.file[0].name
      this.adminStore.uploadShipments(fileName, formData)
        .catch(() => {
          this.modalStore.toggleModal('error')
        })
        .finally(() => {
  ...
  onUploadProductRetirements = (event) => {
    ...
    if (this.isFormValid(this.state)) {
      ...
      formData.append('file', this.state.file[0])
      let fileName = this.state.file[0].name
      this.adminStore.uploadProductRetirements(fileName, formData)
        .catch(() => {
          this.modalStore.toggleModal('error')
        })
        .finally(() => {
          ...
          <div className="product-selection-container-inner" style={{backgroundColor: '#ffffff'}}>
            <div className="product-selection-upload">
              ...
              <div className="product-selection-button">
                <form onSubmit={this.onUploadProducts} className={this.handleInputError(errors, 'file')} >
              ...
              <div className="product-selection-button">
                <form onSubmit={this.onUploadVendors} className={this.handleInputError(errors, 'file')} >
                  <input type="file" id="file" onChange={this.handleFileUpload} />
                  <Button disabled={loading} className={loading ? 'loading':''}  style={{ textTransform: 'none'}} size="medium" type="submit">Upload Vendors</Button>
                </form>
              </div>
              ...
              <div className="product-selection-button">
                <form onSubmit={this.onUploadShipments} className={this.handleInputError(errors, 'file')} >
                  <input type="file" id="file" onChange={this.handleFileUpload} />
                  <Button disabled={loading} className={loading ? 'loading':''}  style={{ textTransform: 'none'}} size="medium" type="submit">Upload Shipments</Button>
                </form>
              </div>
              ...
              <div className="product-selection-button">
                <form onSubmit={this.onUploadSKUs} className={this.handleInputError(errors, 'file')} >
                  <input type="file" id="file" onChange={this.handleFileUpload} />
                  <Button disabled={loading} className={loading ? 'loading':''}  style={{ textTransform: 'none'}} size="medium" type="submit">Upload SKUs</Button>
                </form>
              </div>
