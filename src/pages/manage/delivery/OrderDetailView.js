    ...
    return (
      <section className="page-section delivery-page pt-2">
        <Container>
          ...
          <Grid container>
            <Grid item xs={6} justify={"center"} className={"d-flex"}>
              <Button color="primary" variant={"contained"} onClick={this.onMissing}>Missing</Button>
            </Grid>
            <Grid item xs={6} justify={"center"} className={"d-flex"}>
              <Button color="primary"  variant={"contained"} onClick={this.onDelivered}>Delivered</Button>
            </Grid>
          </Grid>
        </Container>
      </section>
