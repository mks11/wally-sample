          ...
          <Col style={{maxWidth: '180px'}} xs="7">
            <div className={popup ? 'open' : ''}>
              ...
              <div className="package-info-popover addon-popover">
                ...
                <p>This item has add-on option(s): oil spout ($2.50). Add-on items are for you to keep, and not to return to us. Simply swap them onto fresh jars of liquids when you order them, and only return the empty jars.</p>
              </div>
            </div>
