...
export const API_ADMIN_GET_INBOUND_PROD_SHIPMENTS = BASE_URL + "/api/admin/co-packing/shipments/inbound";
export const API_ADMIN_GET_OUTBOUND_PROD_SHIPMENTS = BASE_URL + "/api/admin/co-packing/shipments/outbound";
export const API_ADMIN_UPDATE_PRODUCT_SHIPMENT = BASE_URL + "/api/admin/shipments/";
...
export const API_ADMIN_GET_CO_PACKING_RUNS = BASE_URL + "/api/admin/co-packing/runs";
export const API_UPDATE_SKU_UNIT_WEIGHT = BASE_URL + "/api/admin/co-packing/sku";
export const API_UPLOAD_COPACKING_QR_CODES = BASE_URL + "/api/admin/co-packing/qr-codes";
